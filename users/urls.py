...
app_name = "users"
urlpatterns = [
    path('login_view', auth_views.LoginView.as_view(
        template_name='users/login.html'), name='login_view'),  # 로그인 페이지
    path('logout_view', auth_views.LogoutView.as_view(),
         name='logout_view'),  # 로그아웃 페이지
